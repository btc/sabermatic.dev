...
func TestCallToolAndLog_NilTxPanics(t *testing.T) {
	// CallToolAndLog always persists — passing nil tx is a caller bug
	// that should panic.
	...
	assert.Panics(t, func() {
		_, _ = client.CallToolAndLog(context.Background(), nil, CallToolParams{
			Model:  "claude-opus-4-20250514",
