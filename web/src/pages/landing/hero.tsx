...
export function Hero() {
  ...
  return (
    <section aria-labelledby="hero-heading" className="text-center px-5 pt-36 pb-28 sm:px-6 lg:px-10">
      <div className="mx-auto max-w-[1120px]">
        ...
        <h1
          id="hero-heading"
          className="group mb-9 text-[clamp(32px,10vw,140px)] font-extrabold leading-[0.9] tracking-[-0.055em]"
